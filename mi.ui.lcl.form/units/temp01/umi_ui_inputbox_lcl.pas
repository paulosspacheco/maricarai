...
uses
  ...
  uMi_ui_scrollbox_lcl, uMi_ui_Dmxscroller_form_ds;
...
type
  ...
  TMI_UI_InputBox = class(TForm)
    ...
    procedure DmxScroller_Form1Exit(aDmxScroller: TUiDmxScroller);
...
procedure TMI_UI_InputBox.DmxScroller_Form1NewRecord(
...
begin
  ...
  procedure TMI_UI_InputBox.FormCreate(Sender: TObject);
  begin
    _CanClose := true;
  end;

  procedure TMI_UI_InputBox.CancelButtonClick(Sender: TObject);
  begin

  end;

procedure TMI_UI_InputBox.CloseButtonClick(Sender: TObject);
begin

end;

procedure TMI_UI_InputBox.DmxScroller_Form1AddTemplate(
  const aUiDmxScroller: TUiDmxScroller);
begin

end;

  procedure TMI_UI_InputBox.DmxScroller_Form1CloseQuery(aDmxScroller: TUiDmxScroller; var CanClose: boolean);
  begin
...
//                  UiDmxScroller.DoOnCloseQuery(canClose);
  ...
  procedure TMI_UI_InputBox.DmxScroller_Form1Enter(aDmxScroller: TUiDmxScroller);
  begin
    if Assigned(_OnEnterLocal)
    then _OnEnterLocal(aDmxScroller);
  end;

  procedure TMI_UI_InputBox.DmxScroller_Form1EnterField(aField: pDmxFieldRec);
  begin
    if Assigned(_OnEnterFieldLocal)
    then _OnEnterFieldLocal(aField);
  end;

  procedure TMI_UI_InputBox.DmxScroller_Form1Exit(aDmxScroller: TUiDmxScroller    );
  begin
    if Assigned(_OnExitLocal)
    then _OnExitLocal(aDmxScroller);
  end;

  procedure TMI_UI_InputBox.DmxScroller_Form1ExitField(aField: pDmxFieldRec);
  begin

...
/home/paulosspacheco/v/FPC_3.3.1/fpc/bin/x86_64-linux/pasdoc --use-tipue-search --verbosity=6 --auto-link --language=br.utf8 --marker=: --write-uses-list --staronly --markdown --output=./doc  -S./pasdoc.txt

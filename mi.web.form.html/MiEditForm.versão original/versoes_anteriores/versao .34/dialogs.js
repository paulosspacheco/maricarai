...
export async function messageBox(message, title = 'dialogs', dialogType = 'mtInformation', buttons = ['mbOK']) {
    ...
    dialogs.messageElement.textContent = message; // Define a mensagem do dialogsa
    dialogs.titleElement.textContent = title; // Define o título do dialogsa
...
export async function showMessage(dialogType = 'mtInformation',message) {
    ...
    dialogs.titleElement.textContent = dialogs.getDialogClass(dialogType);//title; // Define o título do dialogs

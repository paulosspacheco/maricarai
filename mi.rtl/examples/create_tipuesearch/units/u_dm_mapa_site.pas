...
type
  ...
  { TTreeNodeMS }
  TTreeNodeMS = class(mi.rtl.TreeNode.TTreenode)
    ...
    public procedure TreeToStringListHtml_Complexa(TreeNode: TTreeNode; var S: TStringList);

   {: O método **@name** código html com um página html Identada}
    public procedure TreeToStringListHtml_Simples(TreeNode:TTreeNode;var S:TStringList);
  end;
...
procedure TTreeNodeMS.TreeToStringListHtml_Complexa(TreeNode: TTreeNode; var S: TStringList);
var
  i: integer;
  str: string;
  TreeNodeItem: TTreeNode;
begin
  ...
  begin
    ...
    begin
      TreeNodeItem := TreeNode.Children.Items[i] as TTreeNode;

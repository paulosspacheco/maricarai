unit mi.rtl.tests;
  {:< - A Unit **@name** reune os testes de uso das classe métodos globais usados pelo pacote **mi.rtl**.
    ...
    - **CÓDIGO FONTE**:
      - @html(<a href="../units/mi.rtl.tests.pas">mi.rtl.tests.pas</a>)
      ...
      - Criado por: Paulo Sérgio da Silva Pacheco paulosspacheco@@yahoo.com.br)
        ...
        - **2021-11-29**
          - 09:05 a 10:10 - T12 Criar exemplos da classe TFileStream com header: 
            - TMi_Rtl_Tests.Test_FileStream_com_header;
        ...
        - **2021-12-13**
          - 20:40 a 22:15
            - Criar método : TMi_Rtl_Tests.Action_test_Logs_WarningExecute
            - Criar método : TMi_Rtl_Tests.Action_test_Logs_ErrorExecute
            - Criar método : TMi_Rtl_Tests.Action_test_Logs_InfoExecute
...
type
  ...
  {: - O formulário **@name** é usado para testar as funções do pacote mi.rtl}

  { TMi_Rtl_Tests }

  TMi_Rtl_Tests = class(TForm)
...
begin
  ...
  begin
    Mask := '/home/paulosspacheco/*';
  end;
  Action_test_FindFirstExecute(Self);
end;


procedure TMi_Rtl_Tests.FormDestroy(Sender: TObject);
begin
...
procedure TMi_Rtl_Tests.Action_Test_OpenFile_exclusive_modeHint(
...
procedure TMi_Rtl_Tests.Action_Test_OpenFile_exclusive_modeExecute(
  Sender: TObject);
...
procedure TMi_Rtl_Tests.Action_Test_OpenFile_exclusive_fmShareExclusiveExecute  (Sender: TObject);
...
procedure TMi_Rtl_Tests.Action_Test_OpenFile_exclusive_fmShareDenyNoneExecute(  Sender: TObject);
...
procedure TMi_Rtl_Tests.Action_test_CopyFileExecute(Sender: TObject);
...
procedure TMi_Rtl_Tests.Action_test_FileTruncateExecute(Sender: TObject);
...
procedure TMi_Rtl_Tests.Action_Test_ResetExecute(Sender: TObject);
...
{$REGION ' TBufferMemory exemplo'}
  ...
  procedure TMi_Rtl_Tests.Action_test_TBufferMemory_Sem_HeaderExecute(Sender: TObject);
  begin
  ...
  {: A procedure @name demonstra o uso da classe  **TObjectss.TBufferStream** quando o registro 0 (zero) do buffer
    ...
    procedure TMi_Rtl_Tests.Test_TBufferMemory_com_header;
    type
      TAluno = record
                 Id : integer;
                 nome : string[35];
  ...
  procedure TMi_Rtl_Tests.Action_test_TBufferMemory_Com_HeaderExecute(  Sender: TObject);
  begin
...
{: A procedure @name demonstra o uso da classe  **TObjectss.TFileStream** quando o registro 0 (zero) do arquivo
  ...
  procedure TMi_Rtl_Tests.Action_Test_FileStream_sem_headerExecute(Sender: TObject    );
  begin
    Test_FileStream_sem_header;
  end;
  ...
  procedure TMi_Rtl_Tests.Action_Test_FileStream_com_headerExecute(Sender: TObject );
  begin
...
procedure TMi_Rtl_Tests.Action_Test_tobjects_dlgs_ConfirmExecute(Sender: TObject);
begin
...
{procedure TMi_Rtl_Tests.Test_Mi_MsgBox_inputBox;
...
procedure TMi_Rtl_Tests.Action_Test_Mi_MsgBox_PromptExecute(Sender: TObject  );
begin
...
procedure TMi_Rtl_Tests.Action_Test_tobjects_dlgs_passwordExecute(  Sender: TObject);
begin
...
procedure TMi_Rtl_Tests.Action_test_CreateMessageDialogExecute(Sender: TObject);
begin
...
LOCALIZAÇÃO:
  ...
  //Alert('CreateMessageDialog',TObjectss.TStrError.ErrorMessage('mi.rtl','mi.Rtl.tests','TStrErrorExecute','',211));
  with TObjectss do
  begin
//    ShowMessageEx(TStrError.ErrorMessage('Teste Mi.UI','mi.Rtl.tests','Action_test_TStrErrorExecute',211));
//    SysMessageBox(TStrError.ErrorMessage('Teste Mi.UI','mi.Rtl.tests','Action_test_TStrErrorExecute',211),'Test_FileStream_sem_header',true);
...
procedure TMi_Rtl_Tests.Action_Test_systemlogExecute(Sender: TObject);
begin
  //dotest;
//    testMultiLog;
...
procedure TMi_Rtl_Tests.Action_test_LogErrorExecute(Sender: TObject);
begin
...
procedure TMi_Rtl_Tests.Action_test_TfilesStreamsExecute(Sender: TObject);
begin
  TabSheet_TfilesStreamsEnter(Self);
end;
...
procedure TMi_Rtl_Tests.Test_String_Asc_GUI_to_Asc_html;
  var
    s1: AnsiString ;
begin
...
procedure TMi_Rtl_Tests.Action_Test_String_Asc_GUI_to_Asc_htmlExecute(  Sender: TObject);
begin
...
procedure TMi_Rtl_Tests.Test_String_Asc_GUI_to_Asc_Ingles;
  var
    s1: AnsiString ;
begin
...
procedure TMi_Rtl_Tests.Action_Test_String_Asc_GUI_to_Asc_InglesExecute(  Sender: TObject);
begin
  Test_String_Asc_GUI_to_Asc_Ingles;
end;

procedure TMi_Rtl_Tests.test_removeAccents;
  var
    s1: AnsiString ;
begin
...
procedure TMi_Rtl_Tests.Action_test_removeAccentsExecute(Sender: TObject);
...
procedure TMi_Rtl_Tests.Action_testExecute(Sender: TObject);
begin
  testGetTempDir;
end;
...
procedure TMi_Rtl_Tests.Action_Test_TMi_Msgbox_LCLExecute(Sender: TObject);
begin
  TObjectss.MI_MsgBox.ShowMessage('A classe MI_MsgBox iniciado em TMi_Rtl_Tests.FormCreate() ');
end;


procedure TMi_Rtl_Tests.Action_test_TTb__Access_CadastraExecute(Sender: TObject);
begin
  TAluno.Cadastra;
  ShowMessage('Comando TAluno.Cadastro; executado.');
end;

procedure TMi_Rtl_Tests.Action_Test_TTb_access_Lista_ordem_crescenteExecute(  Sender: TObject);
begin
  TAluno.Lista_ordem_crescente;
end;

procedure TMi_Rtl_Tests.Action_Test_TTb_access_Lista_ordem_decrescenteExecute( Sender: TObject);
begin
  TAluno.Lista_ordem_Decrescente;
end;

procedure TMi_Rtl_Tests.Action_test_TTb_access_DeleteRecExecute(Sender: TObject  );
begin
  TAluno.DeleteRec;
end;

procedure TMi_Rtl_Tests.Action_Test_TTb_access_SetTransactionExecute(Sender: TObject);
begin

...
uses
  mi_rtl_tarefas_a_fazer, mi.rtl.treenode, fpTemplate, mi.rtl.miStringlist, 
  mi.rtl.MiStringlistbase, mi.rtl.libBinRes, mi.rtl.ApplicationAbstract, 
  mi.rtl.Class_Of_Char, mi.rtl.Types, mi.rtl.Consts, mi.rtl.files, 
  ...
  mi.rtl.objects.Methods.dates, mi.rtl.Objects.Methods.Exception, 
  ...
  mi_rtl_ui_DmxScroller_Buttons, mi_rtl_ui_Dmxscroller, 
  mi.rtl.ui.dmxscroller.inputbox, mi_rtl_ui_dmxscroller_form, 
  mi_rtl_ui_custom_application, mi.rtl.all, LazarusPackageIntf;
...
begin
  ...
  RegisterUnit('mi.rtl.Objectss', @mi.rtl.Objectss.Register);

  ...
  setInfraestruturaTI() {
    try {
      ...
      this.infraestruturaTI =
        ...
        '           <a href="' +
        this.pathRaiz +
        'infraestrutura/linux/shell/index.html">Comandos do shell do Linux </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'infraestrutura/linux/flatpak/index.html">Aplicativo flatpak </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'infraestrutura/linux/git/index.html">Aplicativo Git </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'infraestrutura/linux/nfs/index.html">Network File System (NFS) </a> ' +
        "           ------> Internet <------<br>" +
        // '           <a href=\"' + this.pathRaiz + 'infraestrutura/linux/servidor-dns/index.html">Servidor DNS Bind9 </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'infraestrutura/linux/servidor-web-apache/index.html">Servidor Web Apache2 </a> ' +
        // '           ------> Banco de dados <------<br>' +
  ...
  setProgramacao() {
    try {
      ...
      this.programacao =
        ...
        '           <a href="' +
        this.pathRaiz +
        'programacao/html/js/index.html">Linguagem javascript </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'programacao/html/json/index.html">Linguagem json </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'programacao/html/typescript/index.html">Linguagem typescript </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'programacao/html/markdown/index.html">Linguagem Markdown </a> ' +
        '           <a href="' +
        this.pathRaiz +
        'programacao/nodejs/index.html">Runtime typescript nodejs </a> ' +
  ...
  setLinguagemHumana() {
    try {
      ...
      this.linguagemHumana =
        ...
        '           <a href="' +
        this.pathRaiz +
        'linguas_humanas/portugues/producao_de_textos/index.html">Produção de textos </a> ' +
        "      </div>" +
        "    </div>";
    } catch (error) {
      console.log("Error: " + error);

...
uses
  fpTemplate, mi.rtl.miStringlist, mi.rtl.MiStringlistbase, mi.rtl.libBinRes, 
  mi.rtl.ApplicationAbstract, mi.rtl.Class_Of_Char, mi.rtl.Types, 
  mi.rtl.Consts, mi.rtl.files, mi.rtl.Consts.StrError, mi.rtl.objects.types, 
  ...
  mi_rtl_ui_dmxscroller_form, mi_rtl_ui_custom_application, LazarusPackageIntf;

...
//  type PAction = ^TAction;
  ...
  type
    ...
    {: Usado para criar modelos de formulários dinamicamente usando o método add
...
//        public procedure SetWorkingData(var aWorkingData  ; aDataBlockSize : longint ); Virtual;
        ...
        {: O método **@name** desenha um formulário em uma linha apenas em TScrollingWinControl.

           - **NOTA**
             - O formulário é criado com apena uma linha.

           - **EXEMPLO**:
             - Template := '~Nome~/SSSSSSSSSSSSSSSSSSS ~Idade:~/BB'
        }
       // protected procedure CreateFormLCL(aOwner:TScrollingWinControl);virtual;
        ...
        public procedure ModifyFontsAll_LCL(ctrl: TWinControl;aFontName:String;aSize:integer);virtual;overload;//abstract;
        public procedure ModifyFontsAll_LCL(ctrl: TWinControl;aFontName:String);virtual;overload;//abstract;
        ...
        {$REGION ' ---> Property ActionList : TActionList '}
           ...
           public property ActionList : TActionList Read _ActionList   Write  _ActionList;
...
//                end;
  ...
  *)
  ...
  //    Then Result := '>'+Result;
    ...
    procedure TUiDmxScroller.ModifyFontsAll_LCL(ctrl: TWinControl;aFontName: String; aSize: integer);
    begin

    end;

    procedure TUiDmxScroller.ModifyFontsAll_LCL(ctrl: TWinControl;aFontName: String);
    begin

...
begin
  ...
  Template := '~Nome do Aluno:~\Ssssssssssssssssssss`sssssssssssssssssssss'+ChFN+'Nome'+^M+
    '~     Endereço:~\Ssssssssssssssssssss`sssssssssssssssssssss'+ChFN+'endereco'+^M+
    '~          Cep:~\##-###-###'+ChFN+'cep'+^M+
    '~       Bairro:~\ssssssssssssssssssss`sssss'+ChFN+'bairro'+^M+
    '~       Cidade:~\ssssssssssssssssssss`sssss'+ChFN+'cidade'+^M+
    '~       Estado:~\SS'+ChFN+'estado'+^M+
    '~        Idade:~\BB'+ChFN+'idade'+CharUpperlimit+#64+^M+
    '~    Matricula:~\IIII'+ChFN+'matricula'+^M+
    '~      Valor da~'+^M+
    '~  Mensalidade:~\R,RRR.RR'+ChFN+'mensalidade'+^M;

...
constructor TDmxScroller_Form_Lcl_attributes.create(aOwner: TComponent);
begin
  inherited create(aOwner);
  _FldRadioButtonsAdicionados := TStringList.create;
end;

destructor TDmxScroller_Form_Lcl_attributes.destroy;
begin
...
function TDmxScroller_Form_Lcl_attributes.getFldRadioButtonsAdicionados: TStringList;
begin

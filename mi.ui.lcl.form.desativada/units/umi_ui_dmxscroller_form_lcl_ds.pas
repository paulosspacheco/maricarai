...
implementation
  ...
  { TDmxScroller_Form_Lcl_DS }
  procedure TDmxScroller_Form_Lcl_DS.CreateForm(aaOwner: TComponent);
     var
       aOwner:TScrollingWinControl ;
...
//                          inc(k);
  ...
  //      Logs.Warning('Current Field = %s.', [CurrentField^.FieldName]);
      ...
      If Control is TMi_Ui_DbRadioGroup_Lcl
      Then aTop := aTop + (HeightChar * (Control as TMi_Ui_DbRadioGroup_Lcl).Items.Count-1)
  ...
  procedure TDmxScroller_Form_Lcl_DS.DestroyStruct;

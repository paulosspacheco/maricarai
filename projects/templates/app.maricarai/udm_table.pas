...
uses
  Classes, SysUtils, ActnList, Controls, SQLDB,  DB
  ,mi.rtl.all
...
begin
  ...
  Then begin
         ...
         if dm_connections.Connection
         Then begin
                Mi_SQLQuery1.SetConnection(dm_connections.SQLConnector1,DmxScroller_Form1);
...
function Tdm_table.Locate: TModalResult;
begin

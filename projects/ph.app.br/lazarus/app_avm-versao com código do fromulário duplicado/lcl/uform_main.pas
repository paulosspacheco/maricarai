...
type
  ...
  Tform_main = class(TForm)
    ...
    CmExitApp: TAction;
    Actionform_operadores2: TAction;
    Actionform_operadores: TAction;
    ...
    procedure Actionform_operadores2Execute(Sender: TObject);
    procedure Actionform_operadoresExecute(Sender: TObject);
...
procedure Tform_main.Actionform_operadores2Execute(Sender: TObject);
begin
  DockMaster.ShowControl('form_operadores2',true);
end;

procedure Tform_main.Actionform_operadoresExecute(Sender: TObject);
begin
...
begin
  case AnsiIndexStr(UpperCase(aName),
     ...
     0 : AControl := TFormDock.GetForm(Tform_operadores,aName,DoDisableAutoSizing);
     1 : AControl := TFormDock.GetForm(Tform_operadores2,aName,DoDisableAutoSizing);
     2 : begin AControl := nil; end;

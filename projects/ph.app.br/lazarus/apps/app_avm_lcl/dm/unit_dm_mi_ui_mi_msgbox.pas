...
type
  ...
  Tdm_Mi_ui_mi_msgBox = class(TDataModule)
  ...
  function get_MI_MsgBox: Tdm_Mi_ui_mi_msgBox;

var
  dm_Mi_ui_mi_msgBox: Tdm_Mi_ui_mi_msgBox;
...
function get_MI_MsgBox: Tdm_Mi_ui_mi_msgBox;
begin
  result := dm_Mi_ui_mi_msgBox;
end;

{ Tdm_Mi_ui_mi_msgBox }

function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1InputBox(const aTitle,
                                                    ALabel: AnsiString;
                                                var Buff;
                                                    Template: AnsiString): TModalResult;
  var
...
function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1InputPassword(const aTitle: AnsiString;
                                                     var aPassword: AnsiString): TModalResult;
  var
    v : AnsiString;
begin
...
function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1InputValue(const aTitle, aLabel: AnsiString;
                                               var aValue: Variant): TModalResult;
  var
    v,aResult : Variant;
begin
...
function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1MessageBox(const aMsg: AnsiString
                                              ): TModalResult;
begin
  result := MessageDlg('', aMsg, mtWarning, [mbOk],0);
end;

function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1MessageBox_03(const aMsg: AnsiString;
                                                  DlgType: TMsgDlgType;
...
function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1MessageBox_04(aMsg: AnsiString;
  DlgType: TMsgDlgType; Buttons: TMsgDlgButtons; ButtonDefault: TMsgDlgBtn
  ): TModalResult;
begin
   result := dialogs.MessageDlg(aMsg, DlgType,Buttons, 0);
...
function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1MessageBox_05(ATitle: AnsiString;
                                                 aMsg: AnsiString;
                                                 DlgType: TMsgDlgType;
                                                 Buttons: TMsgDlgButtons;
                                                 ButtonDefault: TMsgDlgBtn): TModalResult;
...
function Tdm_Mi_ui_mi_msgBox.MI_MsgBox1MessageBox_ListBoxRec_PSItem(Atitulo: AnsiString;
                                                                 APSItem: TMI_MsgBoxTypes.PSItem;
                                                                 itemSelection: longint;
                                                                 DlgType: TMsgDlgType;
                                                                 Buttons: TMsgDlgButtons;
...
{: Inicialização do projeto usado para criar o módudlo dm_Mi_ui_mi_msgBox}
initialization

  dm_Mi_ui_mi_msgBox := Tdm_Mi_ui_mi_msgBox.create(nil);
  TObjectss.Set_MI_MsgBox(dm_Mi_ui_mi_msgBox.MI_MsgBox1);

finalization
 FreeAndNil(dm_Mi_ui_mi_msgBox);

...
type
  ...
  { Tformas_de_pagamento }

  Tformas_de_pagamento = class(Tdm_table)
...
procedure Tformas_de_pagamento.DmxScroller_Form1Enter(aDmxScroller: TUiDmxScroller);
begin
...
procedure Tformas_de_pagamento.DmxScroller_Form1AddTemplate(const aUiDmxScroller: TUiDmxScroller);
begin

unit uexpediente_do_medico_data;
...
type
  ...
  { Texpediente_do_medico_data }

  Texpediente_do_medico_data = class(Tdm_table)
...
procedure Texpediente_do_medico_data.DmxScroller_Form1Enter(aDmxScroller: TUiDmxScroller);
begin
...
procedure Texpediente_do_medico_data.DmxScroller_Form1AddTemplate(const aUiDmxScroller: TUiDmxScroller);
begin
  ...
  begin
    ...
    add( '"id_medico:    "\LLLLLL'+chFN+'id_medico');
    add( '"Data:         "\Ddd/mm/yy'+chFN+'dataTime'); // Assume Date como String simplificado
    add('');
    add('');

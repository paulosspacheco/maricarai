...
type
  ...
  Tstatus_da_agenda_ou_consulta = class(Tdm_table)
...
procedure Tstatus_da_agenda_ou_consulta.DmxScroller_Form1Enter(aDmxScroller: TUiDmxScroller);
begin
...
procedure Tstatus_da_agenda_ou_consulta.DmxScroller_Form1AddTemplate(const aUiDmxScroller: TUiDmxScroller);
begin

...
procedure Tintegracao.DmxScroller_Form1Enter(aDmxScroller: TUiDmxScroller);
begin
...
procedure Tintegracao.DmxScroller_Form1AddTemplate(const aUiDmxScroller: TUiDmxScroller);
begin

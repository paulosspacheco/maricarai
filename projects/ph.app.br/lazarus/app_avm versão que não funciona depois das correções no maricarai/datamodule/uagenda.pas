...
procedure Tagenda.DmxScroller_Form1Enter(aDmxScroller: TUiDmxScroller);
begin
...
procedure Tagenda.DmxScroller_Form1AddTemplate(const aUiDmxScroller: TUiDmxScroller);
begin

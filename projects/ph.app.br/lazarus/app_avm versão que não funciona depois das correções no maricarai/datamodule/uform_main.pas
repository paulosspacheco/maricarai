...
uses
  ...
  , udm_connections
  , uFormDock
  , uformas_de_pagamento, uform_formas_de_pagamento
  ;
...
begin
  DockMaster.ShowControl('form_formas_de_pagamento',true);
end;
...
begin
  case AnsiIndexStr(UpperCase(aName),
       [UpperCase('form_formas_de_pagamento'), //0
        UpperCase('1'),
        UpperCase('2'),
        UpperCase('3'),
        UpperCase('4'),
     ...
     0 : begin
           AControl := TFormDock.GetForm(tform_formas_de_pagamento,aName,DoDisableAutoSizing);
           (AControl as Tform_formas_de_pagamento).SetDataModule(Tformas_de_pagamento.Create(AControl));
         end;
     1 : begin
         end;
     2 : begin

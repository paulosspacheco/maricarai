...
begin
  ...
  begin
    ...
    add('~   Vencimento:~\Ssssss'+ChFN+'Vencimento'+CreateOptions(NewSItem('Dia 10',
                                                                 NewSItem('Dia 15',
                                                                 NewSItem('Dia 20',
                                                                 NewSItem('Dia 25',
                                                                 nil)))))+
    ...
    add('~        Prazo:~\BB'+ChFN+'Dias'+CreateOptions(NewSItem('30',
                                                        NewSItem('60',
                                                        NewSItem('90',
                                                        NewSItem('120',
                                                        nil)))))+
...
begin
  ...
  begin
    ...
    add('" Sexo.:"'+ CreateEnumField(TRUE, accNormal, 1,
                                     ...
                                     nil))))+ChFN+'sexo1');
    add('" Estado Civil"');
    add('""\X Casado?                 '+ChFN+'fld11');
    add('""\X Pretende se divorciar?  '+ChFN+'fld12');

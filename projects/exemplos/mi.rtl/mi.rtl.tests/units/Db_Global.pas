...
Type
  TDateMask = (DateMask_yy_mm_dd,
               ...
               DateMask_dd_mm_yy_hh_nn_ss,   // dd/nn/yy hh:nn:ss
               DateMask_ddmmyyhhnnss,        // ddmmyyhhnnss

               DateMask_dd_mm_yy_hh_nn,      // dd/nn/yy hh:nn
               DateMask_ddmmyyhhnn,          // ddmmyyhhnn

               DateMask_dd_mm_yyyy_hh_nn_ss,  // dd/nn/yyyy hh:nn:ss
               DateMask_ddmmyyyyhhnnss,       // dd/nn/yyyy hh:nn:ss

               DateMask_yyyymmddhhnnss        // yyyymmddhhnnss

               );

  THourMask = (HourMask_hh_nn ,
               HourMask_hh_nn_ss,
               HourMask_hh_nn_ss_s1000);
...
//    (Asc_Console : '"';Asc_Ingles :'"';Asc_GUI :'"';Asc_HTML     :'&quot;'), //37 Simbolo para "  // não posso converter automaticamente pq " é palavra reservado do código html
...
{  fldCheckBox,FldRadioButton          =   'K';}  {< 'K'=CheckBox; 'k'=RadioButton }
  ...
  FldDateTime   = 'D';  {< D = TipoData dd/nn/yy}

  FldDateTime = 'd' ;  {< d = Longint;Guarda a data compactada 'dd/nn/yy'}

  FldDateTime  = #1  ;  {< #1 = Longint;Guarda a data compactada '##/##/##'}
  FldSData  = '##/##/##';
...
CONST
 {Comandos do Banco de dados}
  ...
  {TCm}
  CmNulo                =          100 {<84};
  CmNextRecord           = CmNulo + 01;
  CmPrevRecord           = CmNulo + 02;
  CmNextRecordValid      = CmNulo + 03;
  CmPrevRecordValid      = CmNulo + 04;
  CmFindRecord           = CmNulo + 05;
  CmSearchRecord         = CmNulo + 06;
  CmGoEof             = CmNulo + 07;
  CmGoBof             = CmNulo + 08;
  CmLocate          = CmNulo + 09; //Não precisa ser desabilitado
  CmNewRecord           = CmNulo + 10;
  CmDeleteRecord       = CmNulo + 11;
  CmUpdateRecord      = CmNulo + 12;
  CmEditDlg             = CmNulo + 13;
  cmMyOK                = CmNulo + 14;
...
{********************************************************************}
  ...
  CmAddRecord           = CmNortSoft + 001;
  CmDeleteRecord        = CmNortSoft + 002;
  CmGetRecord           = CmNortSoft + 003;
  CmPutRecord           = CmNortSoft + 004;
  CmUpdateRecord        = CmNortSoft + 005;
  CmSearchTop        = CmNortSoft + 006;
  CmSearchKey        = CmNortSoft + 007;
  CmUsedRecs_Valid    = CmNortSoft + 008;
  CmOkEscrevaParametrosDosRelatorios = CmNortSoft + 009;
  CmSelecionaIndice   = CmNortSoft + 010;
  LivreCmVisualisa      = CmNortSoft + 011;
  CmQuitInterno         = CmNortSoft + 012;
  CmSobre               = CmNortSoft + 013;
  CmOnEnter           = CmNortSoft + 014;
  CmOnExit            = CmNortSoft + 015;
  cmCores               = CmNortSoft + 016;
  CmF7                  = CmNortSoft + 017;
  CmLabel_DoubleClick = CmNortSoft + 018;
  cmView_DoubleClick  = CmNortSoft + 019;
  CmOrdemCressante    = CmNortSoft + 020;
  CmOrdemDecrescente  = CmNortSoft + 021;
  CmSelecColunaAtual  = CmNortSoft + 022;
  ...
  CmDoBeforeInsert      = CmNortSoft + 028;
  CmDoBeforePost        = CmNortSoft + 029;
  CmDoBeforeDelete      = CmNortSoft + 030;
  CmDoAfterInsert       = CmNortSoft + 031;
  CmDoAfterPost         = CmNortSoft + 032;
  CmDoAfterDelete       = CmNortSoft + 033;
...
resourcestring //Padrão de código dos recursos é GUI.
  ...
  Const
    ...
    (Active:True; Option_Basic:True; Command:CmLocate;CommandStr:'CmLocate'),
    (Active:True; Option_Basic:True; Command:CmUpdateRecord;CommandStr:'CmUpdateRecord'),
    (Active:True; Option_Basic:True; Command:CmNewRecord;CommandStr:'CmNewRecord'),
    (Active:True; Option_Basic:True; Command:CmDeleteRecord;CommandStr:'CmDeleteRecord'),
    ...
    (Active:True; Option_Basic:true; Command:CmView;CommandStr:'CmView'),
...

{
    ...
    (Active:True; Option_Basic:True; Command:CmSelecionaIndice ;CommandStr:'CmSelecionaIndice'),
    (Active:True; Option_Basic:True; Command:CmOrdemCressante;CommandStr:'CmOrdemCressante'),
    (Active:True; Option_Basic:True; Command:CmOrdemDecrescente;CommandStr:'CmOrdemDecrescente'),
    (Active:True; Option_Basic:True; Command:CmAddRecord;CommandStr:'CmAddRecord'),
    (Active:True; Option_Basic:True; Command:CmDeleteRecord;CommandStr:'CmDeleteRecord'),
    (Active:True; Option_Basic:True; Command:CmGetRecord;CommandStr:'CmGetRecord'),
    (Active:True; Option_Basic:True; Command:CmPutRecord;CommandStr:'CmPutRecord'),
    (Active:True; Option_Basic:True; Command:CmUpdateRecord;CommandStr:'CmUpdateRecord'),
    (Active:True; Option_Basic:True; Command:CmSearchTop;CommandStr:'CmSearchTop'),
    (Active:True; Option_Basic:True; Command:CmSearchKey;CommandStr:'CmSearchKey'),
    (Active:True; Option_Basic:True; Command:CmUsedRecs_Valid;CommandStr:'CmUsedRecs_Valid'),
    (Active:True; Option_Basic:True; Command:CmAddRecord;CommandStr:'CmAddRecord'),
    (Active:True; Option_Basic:True; Command:CmDeleteRecord;CommandStr:'CmDeleteRecord'),
    (Active:True; Option_Basic:True; Command:CmGetRecord;CommandStr:'CmGetRecord'),
    (Active:True; Option_Basic:True; Command:CmPutRecord;CommandStr:'CmPutRecord'),
    ...
    (Active:True; Option_Basic:True; Command:CmSearchKey;CommandStr:'CmSearchKey'),
    (Active:True; Option_Basic:True; Command:CmUsedRecs_Valid;CommandStr:'CmUsedRecs_Valid'),
    (Active:True; Option_Basic:True; Command:CmDoBeforeInsert;CommandStr:'CmDoBeforeInsert'),
    (Active:True; Option_Basic:True; Command:CmDoBeforePost;CommandStr:'CmDoBeforePost'),
    (Active:True; Option_Basic:True; Command:CmDoBeforeDelete;CommandStr:'CmDoBeforeDelete'),
    (Active:True; Option_Basic:True; Command:CmDoAfterInsert;CommandStr:'CmDoAfterInsert'),
...
Function TypeFld(Const aTemplate : tString;Var aSize : SmallWord):AnsiChar;overload;
  ...
  Function If_FldDateTime:Boolean;
  ...
  Begin
    Result := (aTemplate=FldDateTime) or
              ((Pos('dd/nn/yy',aTemplate) <> 0) OR
  ...
  Function If_FldDateTime:Boolean;
    //<  FldDateTime = 'd' ;  {< d = Longint;Guarda a data compactada 'dd/nn/yy'}
  Begin
    Result := (aTemplate=FldDateTime) or (Pos('dd/nn/yy',aTemplate) <> 0);
    If Result
    Then Begin
  ...
  Function If_FldDateTime:Boolean;
    //<  FldDateTime  = #1  ;  {< #1 = Longint;Guarda a data compactada '##/##/##'=FldSData}
  Begin
    Result := (aTemplate = FldDateTime) or (Pos(FldSData,aTemplate) <> 0);
    If Result
    Then Begin
           aSize := sizeof(Longint);
           TypeFld  := FldDateTime;
  ...
  Var
    I,j : Byte;
Begin
    If Not If_fld_DateTimeDos Then //retorna FldDateTime
    If Not If_FldDateTime Then // retorna FldDateTime
    If Not If_FldDateTime Then // retorna FldDateTime
    If Not If_FldDateTime //FldDateTime
    Then Begin
...
Function IsData(Const aTemplate : ShortString):Boolean;
begin
  Result := TypeFld(aTemplate) in [FldDateTime,FldDateTime,FldDateTime,fldDateTimeDos,fldDateTimeDos];
end;
...
Begin
  ...
  Begin
     If Pos(UpperCase(Const_Ext_Array[i]),UpperCase(AFilename))<>0
     Then Begin
            Result := true;
            break;
          end;
...
{$REGION '---> Inicio da Implementacao de TCollectionString'}
  ...
  Begin
    ...
    Then Begin
           ...
           if S<>nil
           then Begin
                  PosFldNum := Pos('\'+fldENum,fldENum_db,S^);
                  if PosFldNum<>0
                  then Begin

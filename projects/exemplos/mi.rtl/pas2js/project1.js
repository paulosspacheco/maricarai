...
rtl.module("SysUtils",["System","RTLConsts","JS"],function () {
  ...
  rtl.createClass(this,"Exception",pas.System.TObject,function () {
    ...
    this.$final = function () {
      this.FNodeJSError = undefined;
      pas.System.TObject.$final.call(this);
    };
    this.Create$1 = function (Msg) {
      this.fMessage = Msg;
      this.FNodeJSError = new Error();
...
rtl.module("NodeJSApp",["System","NodeJS","Classes","SysUtils","Types","JS","CustApp"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  rtl.createClass(this,"TNodeJSApplication",pas.CustApp.TCustomApplication,function () {
    this.DoRun = function () {
    };
    this.ShowException = function (E) {
      if (E !== null) {
        pas.System.Writeln(E.$classname,": ",E.fMessage)}
       else if (this.FExceptObjectJS) pas.System.Writeln(this.FExceptObjectJS);
    };
    this.HandleException = function (Sender) {
...
rtl.module("program",["System","NodeJSApp","JS","Classes","SysUtils","NodeJS"],function () {
  "use strict";
  var $mod = this;
  rtl.createClass(this,"TMyApplication",pas.NodeJSApp.TNodeJSApplication,function () {
    this.DoRun = function () {
      this.Terminate();
    };
    var $r = this.$rtti;

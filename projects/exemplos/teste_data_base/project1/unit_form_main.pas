...
type
  ...
  Tform_main = class(TForm)
    ...
    procedure Actionform_xtable2Execute(Sender: TObject);
...
procedure Tform_main.Actionform_xtable2Execute(Sender: TObject);
begin
  DockMaster.ShowControl('form_xtable2',true);
end;
...
//          (AControl as Tform_operadores).Memo1.Text:='form_operadores';
        end;
     1 : AControl := Tformdock.GetForm(Tform_xtable2,aName,DoDisableAutoSizing);
     2 : begin end;
     3 : begin end;
     4 : begin end;
     5 : begin end;

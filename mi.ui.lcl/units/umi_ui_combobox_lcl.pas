  ...
  TMI_ComboBox_LCL = class(TComboBox)
    ...
    {$REGION ' ---> Property DmxFieldRec : pDmxFieldRec '}
      ...
      {: O atributo **@name** fornece os dados necess�rios para criar o componente TMI_MaskEdit_LCL.
         ...
         - **NOTA**
           - Esses dados devem ser criados pelo m�todo TUiDmxScroller.CreateStruct(var ATemplate : TString)
      }
...
constructor TMI_ComboBox_LCL.Create(aOwner: TComponent;aUiDmxScroller: TUiDmxScroller);
begin
  Create(aOwner);
...
//           DmxFieldRec.vidis_OnExit := False;
  ...
  procedure TMI_ComboBox_LCL.SetUiDmxScroller(aUiDmxScroller: TUiDmxScroller);
  begin
